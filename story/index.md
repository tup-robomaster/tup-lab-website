...
<h2 class="story-heading"><i class="fa-solid fa-clock-rotate-left" style="color: var(--timeline-year-color, #007bff);"></i> 见证 TUP 历程</h2>
<div class="story-grid">
  <!-- Team History Entrance -->
  <a class="story-card" href="{{ '/story/history/' | relative_url }}">
    <div class="story-card-cover" style="background: linear-gradient(135deg, #007bff 0%, #00a1d6 100%); display:flex; align-items:center; justify-content:center; flex-direction:column; color:#fff;">
      <i class="fa-solid fa-history" style="font-size:4rem; margin-bottom:10px;"></i>
      <span style="font-size:1.2rem; font-weight:bold;">2015 - 2024</span>
    </div>
    <div class="story-card-content">
      <div class="story-card-title">战队历史沿革</div>
      <div class="story-card-excerpt">回顾 TUP 成立至今的每一个高光时刻，查看历年成绩、核心队员与技术突破！</div>
    </div>
  </a>
</div>
